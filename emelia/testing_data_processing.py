...
class MyTest(unittest.TestCase):
    ...
    def test_make_alarm_hex_master_set(self):
        ...
        self.assertEqual(result, test_list_one) # the resulting list should contain 74 unique hex codes
        self.assertFalse(result == test_list_two) # the resulting list should not be empty
        test_list_one.sort() # sort the master test array
        self.assertTrue(list_strict_equal(test_list_one, result)) # the resulting array should be sorted
